...
namespace ObjC
{
	public static class OperatorOverloads
	{
		...
		static List<OperatorInfo> OperatorMapping = new List<OperatorInfo>() { 
			...
			new OperatorInfo ("op_LogicalAnd", "And", 2),
			new OperatorInfo ("op_LogicalOr", "Or", 2),
			new OperatorInfo ("op_Assign", "Assign", 2),
			new OperatorInfo ("op_LeftShift", "LeftShift", 2),
			new OperatorInfo ("op_RightShift", "RightShift", 2),
			new OperatorInfo ("op_SignedRightShift", "SignedRightShift", 2),
			new OperatorInfo ("op_UnsignedRightShift  ", "UnsignedRightShift", 2),
